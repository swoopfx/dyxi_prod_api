...
class User extends \Authentication\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Authentication\\Entity\\User' . "\0" . 'id', '' . "\0" . 'Authentication\\Entity\\User' . "\0" . 'fullname', 'username', '' . "\0" . 'Authentication\\Entity\\User' . "\0" . 'email', '' . "\0" . 'Authentication\\Entity\\User' . "\0" . 'password', '' . "\0" . 'Authentication\\Entity\\User' . "\0" . 'role', '' . "\0" . 'Authentication\\Entity\\User' . "\0" . 'state', '' . "\0" . 'Authentication\\Entity\\User' . "\0" . 'question', '' . "\0" . 'Authentication\\Entity\\User' . "\0" . 'answer', 'registrationDate', 'registrationToken', 'emailConfirmed', '' . "\0" . 'Authentication\\Entity\\User' . "\0" . 'isProfiled', '' . "\0" . 'Authentication\\Entity\\User' . "\0" . 'updatedOn', '' . "\0" . 'Authentication\\Entity\\User' . "\0" . 'createdOn', '' . "\0" . 'Authentication\\Entity\\User' . "\0" . 'uid', '' . "\0" . 'Authentication\\Entity\\User' . "\0" . 'uuid', '' . "\0" . 'Authentication\\Entity\\User' . "\0" . 'mobileActivateCode', '' . "\0" . 'Authentication\\Entity\\User' . "\0" . 'nin', '' . "\0" . 'Authentication\\Entity\\User' . "\0" . 'customRegno', '' . "\0" . 'Authentication\\Entity\\User' . "\0" . 'customReferedBy', '' . "\0" . 'Authentication\\Entity\\User' . "\0" . 'googleId', '' . "\0" . 'Authentication\\Entity\\User' . "\0" . 'appleId', '' . "\0" . 'Authentication\\Entity\\User' . "\0" . 'profilePic'];
        }
    ...
    public function getNin()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNin', []);

        return parent::getNin();
    }
    ...
    public function setNin(string $nin)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNin', [$nin]);

        return parent::setNin($nin);
    }
    ...
    public function getCustomRegno()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCustomRegno', []);

        return parent::getCustomRegno();
    }
    ...
    public function setCustomRegno(string $customRegno)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCustomRegno', [$customRegno]);

        return parent::setCustomRegno($customRegno);
    }
    ...
    public function getCustomReferedBy()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCustomReferedBy', []);

        return parent::getCustomReferedBy();
    }
    ...
    public function setCustomReferedBy(string $customReferedBy)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCustomReferedBy', [$customReferedBy]);

        return parent::setCustomReferedBy($customReferedBy);
    }
    ...
    public function getAppleId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAppleId', []);

        return parent::getAppleId();
    }
    ...
    public function setAppleId(?string $appleId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAppleId', [$appleId]);

        return parent::setAppleId($appleId);
    }
