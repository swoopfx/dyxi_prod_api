 ...
 */
class WalletActivity extends \Wallet\Entity\WalletActivity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Wallet\\Entity\\WalletActivity' . "\0" . 'id', '' . "\0" . 'Wallet\\Entity\\WalletActivity' . "\0" . 'name', '' . "\0" . 'Wallet\\Entity\\WalletActivity' . "\0" . 'type', '' . "\0" . 'Wallet\\Entity\\WalletActivity' . "\0" . 'desc', '' . "\0" . 'Wallet\\Entity\\WalletActivity' . "\0" . 'createdOn', '' . "\0" . 'Wallet\\Entity\\WalletActivity' . "\0" . 'wallet'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WalletActivity $proxy) {
