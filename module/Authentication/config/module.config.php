...
use Authentication\Service\Factory\GoogleOAuthServiceFactory;
...
return [
    ...
    'service_manager' => [
        'factories' => [
            ...
            // GoogleAuthService::class => GoogleAuthServiceFactory::class,
            GoogleOAuthService::class => GoogleOAuthServiceFactory::class,
        ],
        'aliases' => [
